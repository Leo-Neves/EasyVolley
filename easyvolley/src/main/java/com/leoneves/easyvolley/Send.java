...
//import br.ufpa.minhaufpa.model.log.Logger;
//import br.ufpa.minhaufpa.model.log.Settings;
...
public class Send {
    ...
    public Send(int method, String url, JSONObject body, Header headers, SendListener sendListener) {
        this.method = method;
...
//            settings.hideThreadInfo();
    ...
    private void onRespostaSuccess(JSONObject jsonResponse) throws JSONException {
        if (sendListener != null)
            sendListener.onSuccess(jsonResponse);
    }
